...
- [ ] Task 1: Document and automate the isolated Python development setup.
...
- [ ] No generated report or unapproved artifact is tracked.

### Phase 2: Report data contract

- [ ] Task 5: Add failing schema tests and v1 JSON Schema documents.
...
- [ ] Task 10: Add the renderer shell, design tokens, and five accessible tab panels.
